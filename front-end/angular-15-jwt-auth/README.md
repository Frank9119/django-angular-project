...
> [Angular 15 + Django: JWT Authentication and Authorization example](https://www.bezkoder.com/angular-15-spring-boot-jwt-auth/)
...
Run `ng serve --port 8081` for a dev server. Navigate to `http://localhost:8090/`.
